CREATE PROCEDURE `usp_employees_u_type`(IN IdtE INT,nameTypeE VARCHAR(45),descriptionTypeEmployees VARCHAR(200),estateTypeEmployees VARCHAR(45), OUT outResult INT)
BEGIN
