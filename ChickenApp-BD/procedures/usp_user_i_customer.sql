CREATE PROCEDURE `usp_client_i_client`(IN pfirstname VARCHAR(45),IN plastname VARCHAR(45),IN pphone VARCHAR(45),IN pemail VARCHAR(45),IN padress VARCHAR(100),IN ppassword VARCHAR(45),OUT oresult INT)
BEGIN
